...
# Configure MATLAB_DESKTOP_PROXY
config = {
    ...
    "doc_url": "https://github.com/mathworks/matlab-desktop-proxy/",
    # Use a single word for extension_name
    # It will be used as a flag when launching the integration.
    # NOTE: This name must be used when setting the entrypoint for matlab_desktop_proxy in setup.py
    "extension_name": matlab_desktop_proxy.get_default_config_name(),
